  ...
  return (
    <main className="joker">
      ...
      <section className="joker-three">
        ...
        >
          <source src="proper.mp4" type="video/mp4" className="brain-img" />
        ...
        <div className="para-po-main">
          ...
          <p className="para-po-big">
            {" "}
            Design Education Series is a new format of an original mini-series
            on the main principles of design, where we share all insights gained
            during our experience at Obys Agency. Typography Principles, Colors
            Combinations{" "}
          </p>

          <p className="para-po-small" id="para-po">
            {" "}
